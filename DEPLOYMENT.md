...
ב־Railway השירות משתמש בחיפוש מילות מפתח קל מול אותו בסיס ידע מאומת, ולכן אינו מוריד מודל embedding בזמן שבונה מסלול. בסביבת הפיתוח נשאר זמין החיפוש הסמנטי המלא. כך השירות מתאים גם למגבלת 1GB RAM של מסלול Railway בסיסי.
